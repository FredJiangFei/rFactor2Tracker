...
namespace rF2SMMonitor
{
  internal partial class TransitionTracker
  {
    ...
    internal void TrackPhase(ref rF2Scoring scoring, ref rF2Telemetry telemetry, ref rF2Extended extended, bool logToFile)
    {
      if (logToFile)
      {
              ...
              || (rF2GamePhase)scoring.mScoringInfo.mGamePhase == rF2GamePhase.GreenFlag))
        {
          ...
          lines.Add("\n");
          lines.Add("************************************************************************************");
          lines.Add("* NEW SESSION 11234444 **********************************************************************");
          lines.Add("************************************************************************************");
    ...
    internal void TrackDamage(ref rF2Scoring scoring, ref rF2Telemetry telemetry, ref rF2Extended extended, bool logToFile)
    {
      if (logToFile)
      {
    ...
    internal void TrackTimings(ref rF2Scoring scoring, ref rF2Telemetry telemetry, ref rF2Rules rules, ref rF2Extended extended, bool logToFile)
    {
    ...
    internal void TrackRules(ref rF2Scoring scoring, ref rF2Telemetry telemetry, ref rF2Rules rules, ref rF2Extended extended, bool logToFile)
    {
      if (logToFile)
      {
